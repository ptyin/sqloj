...
class QueryResultTest
{
    ...
    void serialize() throws Exception
    {
        ...
        ExecutionResult results = SqlExecutionUtils.execute(connection,
                "select * from albums where AlbumId < 10;");
        connection.rollback();
        connection.close();
        String json = results.getLastQueryResult().serialize();
        log.info(String.format("Generated json: %s", json));
        ...
        QueryResult deserializedResult = mapper.readValue(json, QueryResult.class);
