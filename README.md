...
此外，后端使用Flask简化设计了[RESTful API](doc/RESTful API.pdf)。使用源码构建，可以浏览器访问http://127.0.0.1:5366/api来进行查看。而前端负责设计了前期的一些[API](doc/API.md)，功能文档可以在[functions.md](doc/functions.md)查看。
